...
if __name__ == '__main__':
    ...
    adj = simpledialog.askstring(title= 'Greeter', prompt="If you find yourself having to cross a piranha-infested river, here's how to do it... enter an adjective")
    # Get the player to enter an adjective
    liquid = simpledialog.askstring(title= 'Greeter', prompt="enter a type of liquid")
    # Get the player to enter a type of liquid

    # Get the player to enter a body part
    bp = simpledialog.askstring(title= 'Greeter', prompt="enter a body part")
